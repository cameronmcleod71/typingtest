        ...
        <Box paddingY="10px" flexWrap="wrap">
            <HStack>
                ...
                <Box sx={typingTextStyles}>
                    <Cursor isInFocus={props.isInFocus} currentIndex={props.currentIndex} numOfChars={props.testTextLine.reduce(testStateReduce, 0)} isCurrentLine={props.lineNum === props.currentLine.toString()} numOfSpaces={ props.testTextLine[0].space ? props.testTextLine[0].space : 0 } lineNum={props.lineNum}>
